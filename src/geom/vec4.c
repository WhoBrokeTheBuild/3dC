...
bool
Vec4_Equals(Vec4* vecA, Vec4* vecB)
{
...
float
Vec4_Distance(Vec4* vecA, Vec4* vecB)
{
...
void
Vec4_AddVec4(Vec4* vecA, Vec4* vecB)
{
...
Vec4
Vec4_GetAddVec4(Vec4* vecA, Vec4* vecB)
{
    Vec4 tmp = *vecA;
...
Vec4
Vec4_GetAddScalar(Vec4* vec, float scalar)
{
    Vec4 tmp = *vec;
...
void
Vec4_SubVec4(Vec4* vecA, Vec4* vecB)
{
    vecA->x = vecA->x + vecB->x;
    vecA->y = vecA->y + vecB->y;
    vecA->z = vecA->z + vecB->z;
...
Vec4
Vec4_GetSubVec4(Vec4* vecA, Vec4* vecB)
{
    Vec4 tmp = *vecA;
...
Vec4
Vec4_GetSubScalar(Vec4* vec, float scalar)
{
    Vec4 tmp = *vec;
...
Vec4
Vec4_GetDot(Vec4* vecA, Vec4* vecB)
{
    Vec4 tmp = *vecA;
    Vec4_Dot(&tmp, vecB);
    return tmp;
